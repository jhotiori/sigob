...
public class Saldo {
    ...
    public Saldo(int id, BigDecimal valorSaldo, String descricao,
                 String tipo, OffsetDateTime dataSaldo, Venda venda, Caixa caixa) {
    ...
    /**
     * Retorna o Caixa vinculado ao Saldo (se houver)
     *
     * @return caixa do Saldo
     */
    ...
    /**
     * Atribui o Caixa vinculado ao Saldo
     *
     * @param caixa O Caixa vinculado ao Saldo
     */
